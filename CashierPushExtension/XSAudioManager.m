...
-(NSArray *)getMusicArrayWithNum:(NSString *)numStr
{
    ...
    NSMutableArray *finalArr = [[NSMutableArray alloc] initWithObjects:@"syb_shoukuan", nil];
...
- (void)speechWalllentMessage:(NSString *)numStr {
    ...
    AVSpeechUtterance *utterance = [AVSpeechUtterance speechUtteranceWithString:[NSString stringWithFormat:@"**到账%@元",numStr]];
    //指定语音，和朗诵速度
